...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      // Apple-style switch colors
      "data-[state=checked]:bg-[#34C759] data-[state=unchecked]:bg-[#E5E5EA] dark:data-[state=checked]:bg-[#30D158] dark:data-[state=unchecked]:bg-[#3A3A3C]",
      className
    )}
    {...props}
    ref={ref}
